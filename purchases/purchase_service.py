...
class PurchaseService:
    ...
    def add_multiple_stock_from_supplier(products, supplier_id, reference_number=None, notes=None, 
        ...
        last_transaction = StockTransaction.query.filter_by(transaction_type="Purchase").order_by(StockTransaction.id.desc()).first()
    ...
    @staticmethod
    def add_stock_from_supplier(product_id, quantity, supplier_id, purchase_price=None, reference_number=None, notes=None, 
                              total_amount=None, payment_amount=0, payment_method=None, transaction_reference=None):
        """
